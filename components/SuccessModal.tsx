  ...
  return (
    ...
    >
      <View className="flex-1 bg-overlay justify-center items-center px-6">
        <View
          className="bg-card rounded-3xl p-8 w-full max-w-sm"
        ...
        >
          ...
          <View className="items-center mb-8">
            <View className="relative">
              {/* Decorative dots */}
              <View className="absolute -top-8 -left-8 w-4 h-4 bg-primary rounded-full" />
              ...
              <View className="absolute bottom-4 -left-6 w-2 h-2 bg-primary rounded-full" />
